...
public class MainActivity extends AppCompatActivity implements
    ...
    /**
     * Track status of location update Request
     * value check when user click start or stop update button
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buildingLocationSettingsRequest();
     ...
     */
    private void buildingLocationSettingsRequest() {
     ...
     */
    private void buildingGoogleApiClient() {
    ...
    public void startUpdatesButtonHandler(View view) {
        Log.i(TAG, "startUpdatesButtonHandler: ");
    ...
    public void onLocationChanged(Location location) {
        ...
        mLastUpdateTime = DateFormat.getTimeInstance().format(new Date());
        updateLocationUI();
        Toast.makeText(this, getString(R.string.location_updated_message), Toast.LENGTH_SHORT).show();
